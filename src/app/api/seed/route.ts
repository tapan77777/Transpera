...
export async function POST(req: NextRequest) {
  ...
  const tasks: ComplianceTask[] = [
    {
      id: 'KRA-2025-09',
      title: 'KRA/KYC Periodic Review',
      due: new Date(now + 2 * 24 * 3600 * 1000).toISOString(),
      status: 'PENDING',
      category: 'REGULATORY',
    },
    {
      id: 'AML-STR',
      title: 'Monthly STR Submission',
      due: new Date(now - 1 * 24 * 3600 * 1000).toISOString(),
      status: 'OVERDUE',
      category: 'REPORTING',
    },
    {
      id: 'RMS-TEST',
      title: 'Quarterly RMS Backtesting',
      due: new Date(now + 10 * 24 * 3600 * 1000).toISOString(),
      status: 'PENDING',
      category: 'RISK',
    },
    {
      id: 'UCC-HEALTH',
      title: 'UCC Master Reconciliation',
      due: new Date(now - 10 * 24 * 3600 * 1000).toISOString(),
      status: 'COMPLETED',
      category: 'REGULATORY',
    },
